...
describe('add', () => {   test('additionne deux nombres positifs', () => { 
...
describe('multiply', () => {   test('multiplie deux nombres', () => { 
...
describe('factorial', () => { 
  ...
  test('lance une erreur pour un nombre négatif', () => {     expect(() => factorial(-1)).toThrow('Nombre négatif'); 
  }); 
}); 
// test for substract 
describe('subtract', () => {
